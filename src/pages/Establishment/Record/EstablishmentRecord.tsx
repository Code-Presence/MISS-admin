            ...
            <div className={`${container}`}>
                <div className={`${wrapper}`}>
                    ...
                    <div className="h-full rounded-sm">
                        ...
                        <Typography variant="small" className="my-2"> Oferece: </Typography>
                        <div className="grid grid-rows-2 grid-flow-col gap-y-2 gap-x-2">
                            {catalog.map((item, index) => (
                                <Chip key={index} variant="ghost" color={`${item.color}`} value={item.label} className='w-fit'/>
                            ))}
                        </div>
                    </div>
                </div>
